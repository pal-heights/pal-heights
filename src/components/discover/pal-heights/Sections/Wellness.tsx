...
const SLIDES = [
  {
    image:
      "https://pub-df2be1f0ac924e4f81cce390b6cc6cee.r2.dev/Discover%20Pal%20Heights/image-17.jpg",
  },
  {
    image:
      "https://pub-df2be1f0ac924e4f81cce390b6cc6cee.r2.dev/Discover%20Pal%20Heights/image-18.jpg",
  },
];
        ...
        <div className={styles.wrapper}>
          <div className={styles.content}>
            ...
            <div className={styles.subRow}>
              {["Renew Your Zen:", "Surrender to the Art of", "Relaxation"].map(
                (text, i) => (
                  <h2
                    key={i}
                    ref={(el) => {
            ...
            <p ref={descRef} className={styles.paragraph}>
              At Pal Heights, we believe in crafting an unparalleled experience
              for our guests. From our renowned bar and restaurant to the
              addition of Seven Seas Spa, every aspect of your stay is designed
              to ensure your utmost comfort, rejuvenation, and satisfaction.
            </p>
          </div>
