...
const ROOM_SETS = [
  {
    images: [
      {
        label: "Luxe Room",
        src: "https://pub-df2be1f0ac924e4f81cce390b6cc6cee.r2.dev/Discover%20Pal%20Heights/standard-3.jpg",
      },
      {
      ...
      {
        label: "Premium Room",
        src: "https://pub-df2be1f0ac924e4f81cce390b6cc6cee.r2.dev/Discover%20Pal%20Heights/standard-2.jpg",
      },
      {
        label: "Master Room",
        src: "https://pub-df2be1f0ac924e4f81cce390b6cc6cee.r2.dev/Discover%20Pal%20Heights/standard-1.jpg",
      },
      {
        label: "Family Luxe",
        src: "https://pub-df2be1f0ac924e4f81cce390b6cc6cee.r2.dev/Discover%20Pal%20Heights/standard-4.jpg",
      },
    ],
  },
];
...
const ICONS = [
  { label: "Spa", icon: "spa-light.png" },
  { label: "Mini Bar", icon: "minibar-light.png" },
  { label: "Free Wi-Fi", icon: "wifi-light.png" },
  { label: "Hair dryer", icon: "hair-dryer-light.png" },
  { label: "Bottled water", icon: "water-bottle-light.png" },
  { label: "Electronic safe", icon: "e-safe-light.png" },
  { label: "Complementary Bed Tea", icon: "tea-light.png" },
  { label: "In room tea/coffee maker", icon: "coffe-light.png" },
  { label: "Evening Mood changing Drink", icon: "drinks-light.png" },
  {
        ...
        <div className={styles.header}>
          ...
          <div className={styles.headerRight}>
            <p ref={descRef} className={styles.desc}>
              Put a spring back into your step with a stay in the Royale rooms.
              Inspired by the vibrancy of urban spaces, sink into comfort as the
              night slips away & refresh your spirit at dawn. The rooms promise
              a wonderful stay and offer unmatched value.
            </p>
            <a
