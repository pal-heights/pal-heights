...
const SLIDES = [
  { image: "/discover/pal-heights/banquets-1.jpg" },
  { image: "/discover/pal-heights/banquets-2.jpg" },
];
        ...
        <div className={styles.wrapper}>
          <div className={styles.content}>
            ...
            <div className={styles.subRow}>
              {["Where Moments", "Become Memories"].map((text, i) => (
                <h2
                  key={i}
                  ref={(el) => {
            ...
            <p ref={descRef} className={styles.paragraph}>
              Looking for an enchanting venue to host your special occasion or
              corporate gathering? Look no further than our best banquet
              facility Our banquet is the ideal choice to create lasting
              memories. Our state-of-the-art banquet halls are designed to
              accommodate various events, from intimate gatherings to
