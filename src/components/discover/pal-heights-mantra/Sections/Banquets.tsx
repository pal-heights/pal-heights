        ...
        <div className={styles.wrapper}>
          <div className={styles.content}>
            ...
            <p ref={descRef} className={styles.paragraph}>
              Host some of your most memorable events at Pal. Pal has banquet
              halls and conference rooms of varying sizes and specifications
              which can be used to host corporate events, meetings, conferences,
              launches, birthday parties and weddings. Host an event unlike any
              other at our hotels and resorts.
            </p>
          </div>
