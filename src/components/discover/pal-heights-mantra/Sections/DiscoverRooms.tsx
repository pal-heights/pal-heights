    ...
    images: [
      {
        ...
        src: "/discover/pal-heights-mantra/grand-1.jpg",
      },
      { label: "Luxe Room", src: "/discover/pal-heights-mantra/grand-2.jpg" },
      {
        label: "Premium Room",
        src: "/discover/pal-heights-mantra/grand-3.jpg",
      },
      { label: "Master Room", src: "/discover/pal-heights-mantra/grand-4.jpg" },
      { label: "Family Luxe", src: "/discover/pal-heights-mantra/grand-5.jpg" },
    ],
  },
];
        ...
        <div className={styles.header}>
          ...
          <div className={styles.headerRight}>
            <p ref={descRef} className={styles.desc}>
              Spread over 180 square feet, the Grand Room provides everything a
              discerning traveler needs for a comfortable stay in the Twin
              Cities. Equipped with a king sized bed or two single beds, it is
              ideal for couples looking for a getaway or vacation in the city or
              guests traveling alone for business.
            </p>
            <a
