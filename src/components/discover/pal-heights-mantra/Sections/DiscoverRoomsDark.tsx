...
const ROOM_SETS = [
  {
    images: [
      ...
      { label: "Premium Room", src: "/pal-royal-5.jpg" },
      { label: "Master Room", src: "/pal-royal-3.jpg" },
      { label: "Family Luxe", src: "/pal-royal-4.jpg" },
    ],
  },
];
...
const ICONS = [
  ...
  { label: "Fitness Center", icon: "fitness-light.png" },
        ...
        <div className={styles.header}>
          ...
          <div className={styles.headerRight}>
            <p ref={descRef} className={styles.desc}>
              Ideal for business travelers, the 220-square-foot Royal Room
              combines comfort, convenience and a classy contemporary style.
              There is plenty of space to unwind and relax to make yourselves
              feel at home. An extensive in-room dining menu and complimentary
              breakfast are also available to make your experience a memorable
              one.
            </p>
            <a
