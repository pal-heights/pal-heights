    ...
    images: [
      {
        ...
        src: "/discover/pal-heights-mantra/pal-suite-1.webp",
      },
      {
        label: "Luxe Room",
        src: "/discover/pal-heights-mantra/pal-suite-2.webp",
      },
      {
        label: "Premium Room",
        src: "/discover/pal-heights-mantra/pal-suite-3.webp",
      },
      {
        label: "Master Room",
        src: "/discover/pal-heights-mantra/pal-suite-4.webp",
      },
      {
        label: "Family Luxe",
        src: "/discover/pal-heights-mantra/pal-suite-5.webp",
      },
    ],
  },
];
        ...
        <div className={styles.header}>
          ...
          <div className={styles.headerRight}>
            <p ref={descRef} className={styles.desc}>
              The 270-square-foot Mantra Suite can accommodate up to 2 adults
              and 2 children, making it ideal for a family vacation. A separate
              living area and a very comfortable bed will make your days truly
              unforgettable.
            </p>
            <a
