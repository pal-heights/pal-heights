  ...
  images: [
    {
      ...
      src: "/banquets/pal-heights-mantra/cabana-1.jpg",
    },
    {
      label: "Luxe Room",
      src: "/banquets/pal-heights-mantra/cabana-2.jpg",
    },
    {
      label: "Premium Room",
      src: "/banquets/pal-heights-mantra/cabana-3.jpg",
    },
    {
      label: "Master Room",
      src: "/banquets/pal-heights-mantra/cabana-4.jpeg",
    },
    {
      label: "Family Luxe",
      src: "/banquets/pal-heights-mantra/cabana-5.jpg",
    },
  ],
};
        ...
        <div className={styles.header}>
          ...
          <div className={styles.headerRight}>
            <p ref={descRef} className={styles.desc}>
              Perched atop the city, Cabana Rooftop is not just a dining hotspot
              but also an exceptional venue for intimate events and
              celebrations. Spanning 4,800 square feet, this stunning space
              offers a breathtaking view, a stylish poolside deck, and
              impeccable service, making it an ideal choice for smaller
              gatherings. Whether you’re planning a private celebration, a
              corporate meeting, or a lively pool party, Cabana Rooftop provides
              the perfect blend of elegance and vibrancy, ensuring every event
              is a memorable one.
            </p>
          </div>
        </div>
        ...
        <div ref={infoBarRef} className={styles.infoBar}>
          ...
          <div className={styles.infoItem}>
            ...
            <p className={styles.infoValue}>
              <strong>Expansive Rooftop Space:</strong> Spanning 4,800 square
              feet, Poolside Deck, Versatile Venue
              <br />
              <strong>Scenic Ambiance:</strong>
