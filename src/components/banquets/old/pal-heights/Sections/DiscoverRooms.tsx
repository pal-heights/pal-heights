...
const ROOM_SET = {
  images: [
    { label: "Couple Simple Room", src: "/banquets/harmony-1.jpg" },
    { label: "Luxe Room", src: "/banquets/harmony-2.jpg" },
    { label: "Premium Room", src: "/banquets/harmony-3.jpg" },
    { label: "Master Room", src: "/banquets/harmony-4.jpg" },
    { label: "Family Luxe", src: "/banquets/harmony-1.jpg" },
  ],
};
        ...
        <div className={styles.header}>
          ...
          <div className={styles.headerRight}>
            <p ref={descRef} className={styles.desc}>
              ...
              Heights. Harmony is ideal for large-scale weddings.
            </p>
          </div>
        </div>
        ...
        <div ref={infoBarRef} className={styles.infoBar}>
          ...
          <div className={styles.infoItem}>
            ...
            <p className={styles.infoValue}>
              Live tandoor, buffet on wheels, expansive stage
            </p>
          </div>
        </div>
      </div>
